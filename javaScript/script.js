...
var capaDasSeries = [
    ...
    "https://m.media-amazon.com/images/M/MV5BNDVkYjU0MzctMWRmZi00NTkxLTgwZWEtOWVhYjZlYjllYmU4XkEyXkFqcGdeQXVyNTA4NzY1MzY@._V1_UY268_CR0,0,182,268_AL_.jpgg ",
    "https://m.media-amazon.com/images/M/MV5BMjEzMDAxOTUyMV5BMl5BanBnXkFtZTgwNzAxMzYzOTE@._V1_UX182_CR0,0,182,268_AL_.jpg ",
    "https://m.media-amazon.com/images/M/MV5BYTM5MDg3MGMtODAyYy00MGQ0LWJhM2MtZDFmMjAzNTFhZGRmXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_UY268_CR4,0,182,268_AL_.jpg"
];
var trailerSeries = [
    "https://www.youtube.com/watch?v=ZHaokMTWgdY",
    "Trailer não encontrado",
    "https://www.youtube.com/watch?v=0hmzL7qHA1M&t=11s",
    "https://www.youtube.com/watch?v=GodwQKNXIYk"
];
var sinopseDasSeries = [
    "Após os eventos de Vingadores: Ultimato, Sam Wilson/Falcão (Anthony Mackie) e Bucky Barnes/Soldado Invernal (Sebastian Stan) se juntam em uma aventura global que testa suas habilidades - e sua paciência - na série do Marvel Studios Falcão e Soldado Invernal",
...
function selecionarSerie(){
    ...
    var nomeSerie = campoSerieFavorita.value
    var serieListar = 0;
    if(nomeSerie == "Falcão e Soldado Invernal"){
        serieListar = 0;
    }else if (nomeSerie == "Friends"){
        serieListar = 1;
    }else if (nomeSerie == "Stranger Things"){
        serieListar = 2;
    }else if (nomeSerie == "Cidade Invisível"){
        serieListar = 3
    }
    listarSeriesNaTela(serieListar)
}
function listarSeriesNaTela(i) {
